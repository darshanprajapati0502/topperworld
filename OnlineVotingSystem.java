...
class OnlineVotingSystem {
    ...
    public static void main(String[] args) {
        ...
        JRadioButton r2 = new JRadioButton("CONGRESS");
        JRadioButton r3 = new JRadioButton("AAM AADMI");
                ...
                new MouseListener() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        if (A > B && A > C) {
                            ...
                            out = "AAM AADMI PARTY Wins";
                        } else {
                            out = "No Party Wins";
                        }
                        JOptionPane.showMessageDialog(new JFrame(), "BJP gets " + A + " votes\n CONGRESS gets " + B
                                + " votes\n AAM AADMI PARTY gets " + C + "votes\n\n" + out);
                    }
                });
        f.add(p);
        f.setSize(580, 600);
